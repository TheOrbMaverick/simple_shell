...
/**
  * forward_slash - Checks if file starts with "/"
...
/**
  * file_location - Get the executable path of file
...
/**
  * file_path - Get's the full path of the file
...
char *file_path(char *file_name)
{
	...
	full_path = file_location(path, file_name);
